...
fig2toprow <- ggarrange(NULL,p_Reff_inf, NULL, inf_legend, NULL, p_Reff_hosp, NULL, hosp_legend,
...
fig2bottomrow <- ggarrange(p_infection, NULL, p_transmission, NULL, p_hospitalization, percent_legend,
