...
# _____________________________________________________________________
#* I: Get data ####
#* If you want to generate data yourself, start here! Otherwise, skip to line 121 to use pre-generated dataframes.
# _____________________________________________________________________
ptm <- proc.time()
...
# saveRDS(baselinedf,file="df_suppFig5_baseline.RData")
# saveRDS(waningdf,file="df_suppFig5_waning.RData")
# saveRDS(boosteddf,file="df_suppFig5_boosted.RData")
...
ggsave("SuppFig3.pdf", suppfig3, device = cairo_pdf, width = 8, height = 5)
ggsave("SuppFig3.svg", suppfig3, device = svg, width = 8, height = 5)
